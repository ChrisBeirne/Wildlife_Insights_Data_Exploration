...
# Deployments
To date we have deployed cameras in `r length(unique(dep$deployment_id))` camera deployments from `r length(unique(paste(dep$longitude, dep$latitude)))` unique locations (based on X-Y coordinates). 
